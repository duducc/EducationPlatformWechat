...
%> --%>
	...
	<div id="main_div" style="height: 85%;">
		...
		<div class="d1">
			...
			<img style="width:70%" src="${QR_images}"/>
		</div>
	</div>
 ...
 <script type="text/javascript">
	...
	$(document).ready(function () {
 	...
 	function refresh(){
 		...
 		window.location.href="xfProject.do?method=CreditQR&courseId="+courseId+"&SessionToken="+SessionToken+"&clientsxh="+clientsxh+"&type="+type; 
 	}
 </script>
</html>

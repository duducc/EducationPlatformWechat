...
<form class="layui-form layui-form-pane" action=""  id="baseform" method="post">
	...
	<input type="hidden" id="proid" name="proid" value="${entity.proId }"/>
	<input type="hidden" id="proname" name="proname" value="${entity.proName }"/>
	        ...
	        <div style="width: 100%;height: 80px;border-bottom: 0px solid #cccccc;background-color: #65B39D;">
  				...
  				<div style="width: 45%;height: 80px;float: left;">
  					<div style="width: 100%;margin-top: 20px;">
	  					...
	  					<span style="color: #fff;font-size: 15px;">举办时间：${entity.startDate.substring(0,10)}</span>
  					</div>
  				</div>

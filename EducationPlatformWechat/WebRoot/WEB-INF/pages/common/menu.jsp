...
<html>
  ...
  <body>
	...
	<div class="weui_tab_bd">
        ...
        <c:forEach items="${menulist }" var="list">
        	<div class="menudiv" id="${list.menuurl }" onclick="toNextPage(this.id);">
	        	<div class="imagediv">
	        		<img  src="${list.imageurl }" style="width:80%;margin-top: 15%;">
	        	</div>
	        	<div class="textdiv" style="width: 55%;margin-left: 3px;">
	        		<div class="ondiv">
	        			<span style="font-size: 18px;color: #666;height: 30px;line-height: 30px;"><b>${list.menuname}</b></span>
	        		</div>
	        		<div class="updiv">
	        			<span style="font-size: 13px;color: #747474;height: 20px;line-height: 20px;">${list.remark1}</span>
	        		</div>
	        	</div>
  ...
  <script type="text/javascript">
  	function toNextPage(url){
  		var value = "&openid="+$("#openid").val()+"&clientsxh="+$("#clientsxh").val();
  		var sysurl = $("#url").val();
		window.location.href=sysurl+url+value;										
 	}
  </script>
</html>

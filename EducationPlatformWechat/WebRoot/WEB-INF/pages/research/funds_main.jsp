...
<body  ontouchstart>
    <form method="get" id="from1">
        ...
        <c:forEach var="entity"   items="${list}">
        	 <div class='weui_cells weui_cells_access'  onclick="toFunds('${entity.prosequence}')">
  				<a class='weui_cell' href='javascript:;'>
  				<div class='weui_cell_bd weui_cell_primary'>
  				<p style='width: 70%'>${entity.proname}</p>
  				</div>
...
function getDataList(){
    	var spath = "kyProject.do?method=toFunds&name="+$("#proName").val();
		window.open(spath,"toFunds");
    }
function toFunds(data){
	var spath = "kyProject.do?method=toFundsMsg&id="+data;

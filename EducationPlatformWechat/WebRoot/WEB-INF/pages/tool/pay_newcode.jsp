...
<div class="weui_tab">
    ...
    <div class="weui_tab_bd">
        ...
        <div style="padding: 15px 0;">
        	<div style="font-size: 20px;text-align: center;">办卡缴费</div>
            <div style="font-size: 50px;text-align: center;"><b>￥150.00</b></div>
        </div>
        ...
        <div class="weui_cells weui_cells_form">
            ...
            <div class="weui_cell" style="border-bottom: 1px solid #bebebe;text-align:center;" id="wxpay">
            	<img src="images/service/barcodePay.jpg" style="margin-left: 10%;margin-right: 0px;width: 80%;">
            </div>

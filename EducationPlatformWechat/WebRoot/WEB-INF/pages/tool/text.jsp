...
<body>
     ...
     <form name="userForm1" action="applyInfo.do?method=toTextOutputStream" enctype="multipart/form-data" method="post">
		<div id="newUpload1">
 	...
 	<br>
 	 ...
 	 <form name="userForm2" action="text1.do" enctype="multipart/form-data" method="post"">
 		<div id="newUpload2">
			<input type="file" name="file">
		</div>

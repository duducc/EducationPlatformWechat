...
<body>
	...
	<c:if test="${entity.state=='1-2'||entity.state=='2-2'}">
		<div id="up_div" class="up_div_r">
			<div style="width: 150px;float: right;margin-right: 15px;">
	...
	<div class="weui_tab">
  		<div class="weui_tab_bd">
    		<div id="tab1" class="weui_tab_bd_item  weui_tab_bd_item_active" style="background-color: #ffffff;">
	  				...
	  				<div class="layui-collapse" style="margin-top: 0px;" lay-accordion="">
									...
									<c:if test="${shjz==1}">
		    							...
		    							<i class="layui-icon layui-timeline-axis">
		    								<img src="images/service/quan2.png" style="width: 20px;height: 20px;"></i>
  											<div class="layui-timeline-content layui-text">
    											<h3 class="layui-timeline-title"><span style="font-size: 15px;">${entity.teachername }</span>
    											</h3>
    											<ul>
		    								...
		    								<img src="images/service/quan2.png" style="width: 20px;height: 20px;">
  											...
  											<div class="layui-timeline-content layui-text">
    											<h3 class="layui-timeline-title">
    												<span style="font-size: 15px;">${entity.teachername }</span>
    											</h3>
    											<ul>
    												<li>状态：<span style="color: #ccc;">未审核</span></li>
						    				</ul>
						...
						<c:if test="${entity.state=='1-1'||entity.state=='1-2' }">
							<ul class="layui-timeline">
										<li class="layui-timeline-item">
	    							<i class="layui-icon layui-timeline-axis">
							...
							<ul class="layui-timeline">
								<li class="layui-timeline-item">
	    							<i class="layui-icon layui-timeline-axis">
	    								<c:if test="${entity.state=='1-1'}">
		    								<img src="images/service/quan1.png" style="width: 20px;height: 20px;">
	    								</c:if>
	    								<c:if test="${entity.state=='1-2'}">
		    								<img src="images/service/quan2.png" style="width: 20px;height: 20px;">
	    								</c:if>
	    							</i>
 									<div class="layui-timeline-content layui-text">
   											<h3 class="layui-timeline-title"><span style="font-size: 15px;">${entity.teachername }</span></h3>
   											<ul>
   												<li>状态：
   													<c:if test="${entity.state=='1-1'}">
									        ...
									        <li>审核意见：<span style="font-size: 15px;color: blue;"><b>${ksshyj}</b></span></li>
					    				</ul>
 									</div>
								</li>
							</ul>
		    							...
		    							<i class="layui-icon layui-timeline-axis">
			    							<img src="images/service/quan1.png" style="width: 20px;height: 20px;">
  											...
  											<div class="layui-timeline-content layui-text">
										        ...
										        <li>审核意见：<span style="font-size: 15px;color: blue;">${ksshyj}</span></li>
						    				</ul>
  											</div>
 										</li>
								</ul>
	  				...
	  				<div class="layui-collapse" style="margin-top: 0px;" lay-accordion="">
						<div class="layui-colla-item">	
		  					...
		  					<div class="layui-colla-content layui-show">
							    ...
							    <div class="layui-form-item">
								   <div style="width: 49%;border: 0px;float: left;" > 家庭住址:${stuentity.familyaddress }</div> 
							    </div>
							    <div class="layui-form-item">
								   <div style="width: 49%;border: 0px;float: left;" > 学校名称:${schoolname }</div> 
							    </div>
							    <div class="layui-form-item">
								   <div style="width: 30%;border: 0px;float: left;" > 年级:${stuentity.grade}级</div> 
								   <div style="width: 30%;border: 0px;float: left;" > 专业:${zhuanye}</div> 
								   <div style="width: 39%;border: 0px;float: left;" > 班级:${stuentity.banji }班</div> 
							    </div>
		 					</div>
						</div>
					</div>
					<div class="layui-collapse" style="margin-top: 0px;" lay-accordion="">
						<div class="layui-colla-item">	
		  					...
		  					<div class="layui-colla-content layui-show">
							    ...
							    <div class="layui-form-item">
								    ...
								    <div class="layui-input-inline">
								      	<input id="leavedatestart" name="leavedatestart" class="layui-input"  type="text" value="${entity.leavedatestart.substring(0,19)}" disabled="disabled">
								    </div>
							    </div>
							    <div class="layui-form-item">
								    <label class="layui-form-label">结束时间</label>
								    <div class="layui-input-inline">
								      	<input id="leavedateend" name="leavedateend" class="layui-input" type="text" value="${entity.leavedateend.substring(0,19)}" disabled="disabled">
								    </div>
							    </div>
							    <div class="layui-form-item">
								    <label class="layui-form-label">请假时长</label>
								    <div class="layui-input-inline">
								      	<input id="sc" name="sc"  type="text" class="layui-input" value="${sc }" disabled="disabled">
								    </div>
							    </div>
							    <div class="layui-form-item">
								    <label class="layui-form-label">带教老师</label>
								    <div class="layui-input-inline">
								      	<input type="text" class="layui-input" value="${entity.teachername }" disabled="disabled">
								    </div>
							    </div>
						...
						<c:if test="${sptype==1||sptype==2||sptype==4 }">
						 	<div class="layui-form-item layui-form-text">
  		...
  		<c:if test="${sptype!=1&&sptype!=3&&sptype!=2&&sptype!=4 }">
			<div class="weui_tabbar" style="border-top:1px solid #cccccc; height: 50px;">

...
<html>
  ...
  <body>
    <form class="layui-form layui-form-pane" action="" style="width:100%; ">
		...
		<input type="hidden" id="pertype" name="pertype" lay-verify="pertype" value="${pertype }"/><!-- 人员类型（2:实习生） -->
		...
		<div style="overflow-y:auto;height: 85%;background-color: #fff;" id="mainCount_div">
			...
			<div class="layui-collapse" style="margin-top: 10px;" lay-accordion="">
				<div class="layui-colla-item">	
  					<h2 class="layui-colla-title">实习信息</h2>
  					<div class="layui-colla-content layui-show">
  						<div class="layui-form-item">
						    <label class="layui-form-label" style="color:red;" >实习类型</label>
						    <div class="layui-input-inline">
						...
						<div class="layui-form-item">
						    <label class="layui-form-label" style="color:red;" >实习年度</label>
						    <div class="layui-input-inline">
					    ...
					    <div class="layui-form-item">
						    <label class="layui-form-label" >实习月数</label>
						    <div class="layui-input-inline">
			...
			<div class="layui-collapse" style="margin-top: 10px;" lay-accordion="">
				<div class="layui-colla-item">	
  					...
  					<div class="layui-colla-content layui-show">
					    ...
					    <div class="layui-form-item" id="sdshrxx" style="display: none;">
						    <label class="layui-form-label" style="color:red;" >手动输入</label>
						    <div class="layui-input-inline">
						    	<input type="text" id="sdschoolname" name="sdschoolname" lay-verify="sdschoolname" class="layui-input" placeholder="请输入学校名称" value="${entity.remark5 }"/>
						    </div>
					    </div>
					    <div class="layui-form-item">
			...
			<div style="width: 100%;height: 50px;margin-bottom: 20px;padding: 5px;">
				...
				<span style="font-size: 14px;">我已阅读并同意实习生协议</span><a onclick="openxy();" style="font-size: 14px;margin-left: 15px;color: blue;">《实习生协议》</a>
			</div>
		</div>
...
<script type="text/javascript">
    ...
    $(function(){
    	...
    	if(graduateschool=='01000010'){
    		document.getElementById('sdshrxx').style.display ='block';
    	}
    });
    layui.use(['form', 'layedit', 'laydate','upload'], function(){
		...
		form.on('select(graduateschool)', function(data){
			var name = data.elem[data.elem.selectedIndex].text;
			if(data.value=='01000010'){
				document.getElementById('sdshrxx').style.display ='block';
			}else{
				document.getElementById('sdshrxx').style.display ='none';
        ...
        */
		...
		form.on('submit(submit_baseinfo)', function(data){
			...
			$.post(url,{taskinfo:encodeURI(taskinfo),openid:openid,clientsxh:clientsxh,type:'s',professionalname:professionalname,graduateschoolname:graduateschoolname,sdschoolname:sdschoolname},function (data, status) {
		        if( status=="success" ){
		            var json = eval(data);
		            switch (json.errorMsg) {
		            	case "idcarderror":		//成功
			               layer.msg("身份证填写错误！", {icon: 5});
			               break;
			            case "chunfu":		//成功

	...
	<div class="weui_tab">
		<div style="width: 100%;height: 80px;border-bottom: 0px solid #cccccc;background-color: #65B39D;">
			...
			<div style="width: 45%;height: 80px;float: left;">
				<div style="width: 100%;margin-top: 26px;">
					<span style="color: #fff;font-size: 18px;"><b>账号查询</b></span><br>
					<span style="color: #fff;font-size: 15px;">请输入身份证号查询</span>
				</div>
			</div>
		...
		<div class="weui_cells weui_cells_form" style="margin-top: 0px;">
 			<div style="width: 100%;; height: 30px;border-bottom: 1px solid #cccccc;background-color:#DCDDC0; ">
  				<span style="color: red;font-size: 14px;margin-left: 15px;">若无数据，请联系管理员查看身份证号是否正确</span><br>
 			</div>
    	</div>
        <div class="main_tabstyle" style="margin:5px 5px 5px;"> 
	   		<input placeholder="请输入身份证号码" class="form-control" name="idcard" id="idcard" type="text" style="width: 60%;margin-top: 5px;">
        ...
        <div style="width: 98%;overflow-y:auto;height:400px;border:1px solid #ccc;margin-left: 1%;" id="countdivout">
        </div>
	</div>
</form>
<!--js类库-->
 ...
 <script type="text/javascript">
 	function findproject(){
		...
		document.getElementById("up_div").style.display = "block";
		 $.ajax({
		 	url: 'xfemployee.do?method=getuserInfoByidcard&idcard='+idcard,
		  	cache: false,
		  	async: true,  
		  	type:'post',
		  	dataType:'json',

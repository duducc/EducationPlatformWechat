    	...
    	<div class="weui_tab_bd">
	        <div style="width: 100%;height: 80px;border-bottom: 0px solid #cccccc;background-color: #65B39D;">
        		...
        		<div style="padding: 3px;overflow-y:auto;height: 89%;">
					...
					<div class="layui-form-item" style="margin-top: -3px;">
					    <label class="layui-form-label">讨论时间：</label>
					    <div class="layui-input-inline">
					...
					<div class="layui-form-item layui-form-text">
					 	<label class="layui-form-label">讨论目的</label>
					    <div class="layui-input-block" style="margin-top: -5px;">
					      <textarea placeholder="请输入内容" class="layui-textarea" id="tlAmsnmd" name="tlAmsnmd" lay-verify="tlAmsnmd" style="height: 50px;">${entity.tlAmsnmd }</textarea>
					 	</div>
					</div>
					<div class="layui-form-item layui-form-text">
					 	<label class="layui-form-label">发言摘要</label>
					    <div class="layui-input-block" style="margin-top: -5px;">
				...
				<div class="weui_tabbar" style="border-top:1px solid #cccccc; height: 50px;">
			    	...
			    	<div class="layui-form-item" style="text-align: center;margin-top: 4px;float: left;width: 50%;">
				      	<button type="button" class="layui-btn layui-btn-primary" onclick="close_windos();"><i class="layui-icon">&#x1007;</i>关闭</button>
			    	</div>
			    	<c:if test="${opinion==1 }">
			    		<div class="layui-form-item" style="text-align: center;margin-top: 4px;float: left;width: 50%;">
			    			<button type="button" class="layui-btn layui-btn-warm" onclick="djshc_pj();"><i class="layui-icon">&#xe6c9;</i>评价</button>
				    	</div>
			    		<div class="layui-form-item" style="text-align: center;margin-top: 4px;float: left;width: 50%;">
					      	<button type="button" class="layui-btn layui-btn-danger" onclick="deletedata();"><i class="layui-icon">&#xe640;</i>删除</button>
				    	</div>
			    	</c:if>
				</div>
				<!---------------------------------------------------底部菜单 ----------------------------------------------------- -->
	  ...
	  function close_windos(){WeixinJSBridge.call('closeWindow')}
		layui.use(['form', 'layedit', 'laydate','element'], function(){
			  ...
			  form.verify({
				  ...
				  contento: function(value){if(value==""||value==null){return '请填写发言摘要！'}},
				  tlAmsnmd: function(value){if(value==""||value==null){return '请填写讨论目的！'}},
			  });
			  //监听提交
		...
		function djshc_pj(){
			...
			var openid = $("#openid").val();
	 		...
	 		+"&teacherId="+teacherId+"&teacherName="+teacherName+"&type="+type+"&zttime="+zttime;
		}
</script>
</body>
</html>

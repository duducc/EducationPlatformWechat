	        ...
	        <div style="width: 100%;height: 80px;border-bottom: 0px solid #cccccc;background-color: #65B39D;">
        		...
        		<div style="padding: 3px;overflow-y:auto;height: 89%;">
					...
					<div class="layui-form-item">
					    ...
					    <div class="layui-input-inline">
					      <input id="position" type="text" name="position" value="${entity.position }"  lay-verify="position" placeholder="请输入地点名称" autocomplete="off" class="layui-input" style="height:38px;">
					    </div>
					</div>
					<div class="layui-form-item">
					...
					<div class="layui-form-item">
					 	<label class="layui-form-label">讲授题目</label>
					 	<div class="layui-input-inline">
					      <input id="jzCourse" type="text" name="jzCourse" value="${entity.jzCourse }"  lay-verify="jzCourse" placeholder="请输入讲座题目" autocomplete="off" class="layui-input" style="height:38px;">
					    </div>
					</div>
					<div class="layui-form-item layui-form-text">
					 	<label class="layui-form-label">
					 	参加人员
					 	<button type="button" class="layui-btn" style="margin-top: -9px;float: right;margin-right: -15px;" onclick="getEmp();"><i class="layui-icon">&#xe654;</i>添加学员</button>
...
<script>
	...
	layui.use(['form', 'layedit', 'laydate','element'], function(){
		...
		function closeQueryLayerStu(data){
			...
			if(jzPersonid.indexOf(data.xh) == -1){
				if(jzPersonid!=""){
					$("#jzPersonid").val(jzPersonid+','+data.xh);
					$("#jzPersonname").val(jzPersonname+','+data.name);
				}else{
					$("#jzPersonid").val(data.xh);
					$("#jzPersonname").val(data.name);
				}
			}else{

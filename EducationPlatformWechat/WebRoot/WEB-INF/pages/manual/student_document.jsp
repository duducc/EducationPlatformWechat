...
<body>
    ...
    <div class="weui_tab_bd">
	    ...
	    <div style="width: 94%;margin-left:3%;margin-top:10px;border:1px solid #cccccc; padding:20px;">
	    	...
	    	<br><br>
	    	<p><h4 class="head_s">2：注册账号。</h4></p>
	    	<p class="head">
	    		点击【个人中心】--【我的信息】，弹出界面中选择【账号注册】，选择人员类型，进入到注册页面，按照要求填写相关内容，点击“立即提交”按钮，完成账号注册。以上操作完成后，只需等待会议开始前前往二维码扫描签到处扫码签到即可。
	    	</p>
	    	<p>
	    		<img src="images/czwd/wdxxcd.png" style="width: 46%;height: 300px;">
	    		<img src="images/czwd/zhhzhc.png" style="width: 46%;margin-left:3%; height: 300px;">
	    	</p>
	    	<p>
	    		<img src="images/czwd/zhccd.png" style="width: 46%;margin-top:10px; height: 300px;">
	    		<img src="images/czwd/zhcym.png" style="width: 46%;margin-left:3%; height: 300px;">
	    	</p>
	    	<br><br>
